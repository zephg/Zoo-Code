...
export const modelInfoSchema = z.object({
	...
	// Capability flag to indicate whether the model exposes an adaptive-thinking display toggle
	// (maps to Anthropic's `thinking.display: "summarized" | "omitted"`).
	supportsReasoningDisplay: z.boolean().optional(),
