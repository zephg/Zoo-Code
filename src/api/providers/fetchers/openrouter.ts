...
export const parseOpenRouterModel = ({
	...
	// Opus 5 is adaptive-thinking only and rejects budget_tokens; mirror the static effort
	// shape (like the opus/fable/sonnet rules above) so xhigh/max stay reachable and
	// getAnthropicReasoning takes the effort/adaptive branch, not the legacy budget one.
